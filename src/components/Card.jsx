...
export const Card = () => {
  const { setErrors, query, setData, data, setInput, input, setHeading } = useContext(StateContext);
  ...
  return (
    <>
      {loading ? (
        ...
        data.map((article) => (
          <div key={article.url} id='card' className="card relative xl:w-[18vw] lg:w-[21vw] my-[19px] shadow-md bg-white">
            ...
            <div id="news-content" className="lg:h-[200px] xl:h-[210px] px-[9px] py-[5px] bg-white text-black text-sm">
